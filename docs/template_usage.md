...
Assuming you are in `/your/path/to/binsparse`. Add all files and commit.
...
git remote add origin https://github.com/ivirshup/binsparse.git
...
Your project should be now available at `https://github.com/ivirshup/binsparse`. While the repository at this point can be directly used, there are few remaining steps that needs to be done in order to achieve full functionality.
...
The workflows should now succeed and you will be able to find the code coverage at this link: `https://app.codecov.io/gh/ivirshup/binsparse`. You might have to wait couple of minutes and the coverage of this repository should be ~60%.
